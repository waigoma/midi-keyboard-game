...
namespace MidiPlayerTK
{
    ...
    public partial class MidiSynth : MonoBehaviour
    {
        ...
        /// </summary>
        [Range(0.01f, 0.5f), HideInInspector]
        ...
        /// </summary>
        [Range(0.001f, 1f), HideInInspector]
            ...
            set
            {
                if (MPTK_EnableFreeSynthRate)
                {
                    ...
                    if (OutputRate != value)
                    {
                        ...
                        //Debug.Log($"New OutputRate: {OutputRate} ac.sampleRate:{ac.sampleRate}");
#if MPTK_PRO
                        InitEffect();
#endif
                        if (ActiveVoices != null)
                            for (int i = 0; i < ActiveVoices.Count; i++)
                                ActiveVoices[i].output_rate = ac.sampleRate;
        ...
        private static void ResetAudio(AudioConfiguration ac)
        {
            ...
            foreach (AudioSource audioSource in FindObjectsOfType<AudioSource>())
            {
                ...
                if (audioSource.name.Contains("Midi"))
            ...
            set
            {
                ...
                Debug.Log("Can't change audio configuration on this device");
                    ...
                    else
                    {
                        ...
                        AudioConfiguration ac = AudioSettings.GetConfiguration();
                        if (ac.dspBufferSize != bufferSize)
                        {
                            if (VerboseSynth)
                                Debug.Log($"Change Buffer Size from {ac.dspBufferSize} to {bufferSize}");
